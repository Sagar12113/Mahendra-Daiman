    ...
    return (
        <>
            <div className="w-full flex-col md:flex-row flex items-center">
                ...
                <h1 style={{ 'borderLeft': '8px solid black' }} className='text-sm ml-3 font-semibold mt-5 text-black px-3 mb-3'>Active suggestions</h1>
                <h1 style={{ 'borderLeft': '8px solid black' }} className='text-sm ml-3 font-semibold mt-0 text-black px-3 mb-3'>Periodic reviews</h1>
                <h1 style={{ 'borderLeft': '8px solid black' }} className='text-sm ml-3 font-semibold mt-0 text-black px-3 mb-3'>Silent remarks</h1>
                <h1 style={{ 'borderLeft': '8px solid black' }} className='text-sm ml-3 font-semibold mt-0 text-black px-3 mb-3'>Transparent functioning</h1>
                <h1 style={{ 'borderLeft': '8px solid black' }} className='text-sm ml-3 font-semibold mt-0 text-black px-3 mb-3'>Call support</h1>
                <h1 style={{ 'borderLeft': '8px solid black' }} className='text-sm ml-3 font-semibold mt-0 text-black px-3 mb-3'>Government schemes</h1>
                <h1 style={{ 'borderLeft': '8px solid black' }} className='text-sm ml-3 font-semibold mt-0 text-black px-3 mb-3'>Surveys and questions</h1>
                <h1 style={{ 'borderLeft': '8px solid black' }} className='text-sm ml-3 font-semibold mt-0 text-black px-3 mb-3'>Etc.</h1>
